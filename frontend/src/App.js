...
class App extends Component {
    ...
    connect(url) {
        this.setState({socket: new Socket(url,(msg) => {
                this.setState(_ => {
        ...
        return (
            <div className="App">
                <div className="content">
                    <CommandPanel socketConnector={this.connect} state={this.state} toggleConsole={this.toggleConsole} />
                    <CommandHistory socket={this.state.socket} isDeveloped={this.state.consoleDeveloped} commandHistory={this.state.commandHistory} />
                </div>
            </div>
        );
    }
